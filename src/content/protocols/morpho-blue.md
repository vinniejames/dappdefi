...
slug: morpho-blue
category: lending
subcategories: [isolated-pools, overcollateralized]
chains: [Ethereum, Base, "Hyperliquid L1", Katana, Monad, Arbitrum, Flare, Sei, "World Chain", Optimism, Polygon, "Plume Mainnet", Stable, Etherlink, Unichain, Hemi, Abstract, Celo, Citrea, TAC, Lisk, Soneium, Scroll, Corn, Fraxtal, Sonic, Binance, Botanix, Ink, Zircuit, xDai, Linea, Mode, Tempo, Bitlayer]
